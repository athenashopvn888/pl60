"""
The Planet 60 — Product Update Script
===================================
Drop your ONHAND CSV into the the-planet-60 folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  The Planet 60 — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://theplanet60.com")
    else:
