...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at The Planet 60, Brampton.",
    seoDescription: "The Planet 60 carries a curated selection of magic mushrooms and specialty products in Brampton. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 1098 Peter Robertson Blvd #10 for our full selection.",
    faqs: [
