...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "faq": "",
    "internal_links_used": "[Flower menu](/premium)\\n[Current menu categories](/)\\n[The Planet 60 store page](/weed-dispensary-brampton)\\n[The Planet 60 blog](/blog)",
    "relatedLinks": [
      {
        "title": "Flower menu",
        "url": "/premium",
    ...
    "primaryKeyword": "weed dispensary in Brampton",
    "keywords": [
      "weed dispensary in Brampton",
      "cannabis store in Brampton",
      "Brampton weed store",
      "24 hour cannabis store",
      "weed store",
      "cannabis dispensary"
    ],
    "oldTitle": "Planet 60 Cannabis Brampton Guide",
    "wordCount": 502,
    "businessReviewFlags": []
  },
  {
    ...
    "primaryKeyword": "flower menu Brampton",
    "keywords": [
      "weed dispensary in Brampton",
      "cannabis store in Brampton",
      "Brampton weed store",
    ...
    "oldTitle": "Planet 60 Cannabis Price and Flower Tier Guide",
    "wordCount": 550,
    "businessReviewFlags": []
  },
  {
    ...
    "primaryKeyword": "cannabis menu Brampton",
    "keywords": [
      "weed dispensary in Brampton",
      "cannabis store in Brampton",
      "Brampton weed store",
    ...
    "oldTitle": "Planet 60 Cannabis Local Visit Guide for Adults 19+",
    "wordCount": 533,
    "businessReviewFlags": []
  }
];
