...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why The Planet 60 is Brampton's Best Dispensary",
...
export default function BlogPage() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=PL601`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 The Planet 60 <span className={styles.heroAccent}>Blog</span>
          </h1>
