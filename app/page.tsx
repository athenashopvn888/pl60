...
const LOCAL_FAQS = [
  {
    ...
    a: "The Planet 60 at 1098 Peter Robertson Blvd #10, Brampton is Open 24 Hours a day, 7 days a week. Walk in anytime — no appointment needed.",
  },
  {
  ...
  },
  {
    ...
    a: "We are located at 1098 Peter Robertson Blvd #10, Brampton, ON L6R 1G6. Visit us in person or call us at +1 (289) 206-0899. Free evening parking is available nearby.",
  },
  {
      ...
      <section className={styles.welcomeBannerSection}>
        <div className={styles.welcomeBannerContainer}>
          <img
            ...
            alt="Welcome to The Planet 60 — Premium Brampton Cannabis Dispensary"
          ...
          <div className={styles.storeGrid}>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                ...
                <br />
                <span className={styles.storeHighlight}>Springdale, Brampton</span>
              </p>
            </div>
          </div>
