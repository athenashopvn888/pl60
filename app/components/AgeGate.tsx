...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("PL601_age_verified");
    if (verified !== "true") {
  ...
  const handleVerify = () => {
    localStorage.setItem("PL601_age_verified", "true");
    setShow(false);
  };
      ...
      <div className={styles.modal}>
        {underage ? (
          ...
          <div className={styles.promptState}>
            ...
            <p className={styles.text}>
              The Planet 60 requires all visitors to be of legal age.
