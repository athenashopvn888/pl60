"""
The Planet 60 - Auto Sync from Google Sheets
==========================================
...
a filtered menu for The Planet 60 (ALC01).
...
# ============================================================
STORE_CODE = "PL601"  # After Dark store code
...
def main():
    print("=" * 60)
    print(f"  The Planet 60 - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://theplanet60.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
